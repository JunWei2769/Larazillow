    ...
    <form @submit.prevent="register">
        <div class="w-1/2 mx-auto">
            ...
            <div class="mt-4">
                ...
                <input type="password" id="email" class="input" v-model="form.password" />
            ...
            <div class="mt-4">
                ...
                <div class="input-error" v-if="form.errors.password_confirmation">{{ form.errors.password_confirmation }}
                </div>
            </div>
            <div class="mt-4">
...
// the error message can be accessed using keyword "form.errors.xxx"
const form = useForm({
    name: null,
    email: null,
    password: null,
